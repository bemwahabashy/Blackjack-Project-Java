...
public class Project3 extends JFrame implements ActionListener {
    ...
    // private boolean playerStay = false;//true if stay button has been hit, false
    // otherwise
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == dealButton) {
            if (gameOver == false && (playerHand.getNumCards() == 0)
                    && (dealerHand.getNumCards() == 0 && (deal == false))) {
                message = "";
                dealCard(playerHand);
                dealCard(dealerHand);
                dealCard(playerHand);
    ...
    class MyPanel extends JPanel {
        ...
        public void paintComponent(Graphics g) {
            ...
            if (current != null && gameOver == false) {
                ...
                Image flipped = Project3.load_picture("images/gbCard52.gif");
